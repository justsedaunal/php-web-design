...
<div class="container my-5">
    ...
    <form method="post" enctype="multipart/form-data" action="insert.php">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" placeholder="Ürün Fiyatını Dolar Cinsinden Giriniz" name="product_price">
        </div>
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary mt-4" name="productadd">Ekle</button>
    </form>
