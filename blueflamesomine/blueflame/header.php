                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse menu" id="navbarNavDropdown">
                            ...
                            <ul>
                                ...
                                $rows=$db->query("SELECT * FROM category where parent_id=0",PDO::FETCH_NUM)->fetchAll();
                                // print_r($rows); exit();
                                ...
                                <li class="nav-item">
          <a class="nav-link " aria-current="page" href="index.php?category_id=<?= $rows[$i][0] ?>"><?= $rows[$i][1] ?></a>
        </li>
