...
if($action=='addcart' && $_SERVER['REQUEST_METHOD']=='POST') {
	...
	$_SESSION['products'][$_POST['sku']] =array(
                                          ...
                                          // print_r(	$_SESSION['products'][$_POST['sku']]); exit();
	$product='';
...
// ?>
  ...
  <!-- <div class="row">
    <div class="container" style="width:600px;">
      ...
      <div class="col-md-4">
        <div class="thumbnail"> <img src="./../../blueflamesomine/uploads/ <?= $product['product_image']?>" alt="Lights">
          <div class="caption">
            <p style="text-align:center;"><?php print $product['product_name']?></p>
            <p style="text-align:center;color:#04B745;"><b>$<?php print $product['product_price']*$dolar?></b></p>
